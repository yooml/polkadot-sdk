...
This crate contains the BABE (Blind Assignment for Blockchain Extension) consensus.
...
The reference about this crate can be found [here](https://paritytech.github.io/polkadot-sdk/master/sc_consensus_babe).
