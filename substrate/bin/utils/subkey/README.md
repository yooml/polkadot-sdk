...
This crate contains a commandline utility, that allows generating and restoring keys for Substrate based
...
The reference about this crate can be found [here](https://paritytech.github.io/polkadot-sdk/master/subkey).
