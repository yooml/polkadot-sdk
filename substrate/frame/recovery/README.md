...
This crate contains an account recovery pallet.
...
The reference about this crate can be found [here](https://paritytech.github.io/polkadot-sdk/master/pallet_recovery).
